...
import { partnerships } from "@/lib/mock-data";
  ...
  return (
    <div className="max-w-[1400px] mx-auto flex flex-col gap-10 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <MetricCard label="Total Partners" value={partnerships.length} icon={Users} />
        <MetricCard label="Active Reach" value="1.2M" icon={Globe} />
        <MetricCard label="In Negotiation" value="4" icon={Handshake} />
        <MetricCard label="Impact Score" value="8.4" icon={Star} />
      </div>
